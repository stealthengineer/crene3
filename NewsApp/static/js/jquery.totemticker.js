...
(function( $ ){
  ...
  $.omr.totemticker.defaultOptions = {
		...
		max_items	: 	4, 		/* Integer for how many items to display at once. Resizes height accordingly (OPTIONAL) */
  };
...
document.querySelector('.copy-icon').addEventListener('click', function() {
	...
	// You can provide user feedback here (e.g., show a tooltip or alert)
